...
// Backward compatibility: current firmware fetches a merged payload from /api/esp.txt.
static const char *DASHBOARD_URL = "http://192.168.168.138:8765/api/esp.txt";
